...
my %AjaxLibs = (
	'jquery'        => ['1.3.2','http://ajax.googleapis.com/ajax/libs/jquery/%s/jquery.min.js'],
	'jqueryui'      => ['1.7.2','http://ajax.googleapis.com/ajax/libs/jqueryui/%s/jquery-ui.min.js'],
	'prototype'     => ['1.6.1.0','http://ajax.googleapis.com/ajax/libs/prototype/%s/prototype.js'],
	'scriptaculous' => ['1.8.2', 'http://ajax.googleapis.com/ajax/libs/scriptaculous/%s/scriptaculous.js'],
	'mootools'      => ['1.2.3', 'http://ajax.googleapis.com/ajax/libs/mootools/%s/mootools-yui-compressed.js'],
	'dojo'          => ['1.3.2', 'http://ajax.googleapis.com/ajax/libs/dojo/%s/dojo/dojo.xd.js'],
	'swfobject'     => ['2.2', 'http://ajax.googleapis.com/ajax/libs/swfobject/%s/swfobject.js'],
	'yui'           => ['2.7.0', 'http://ajax.googleapis.com/ajax/libs/yui/%s/build/yuiloader/yuiloader-min.js'],
	'ext_core'      => ['3.0.0', 'http://ajax.googleapis.com/ajax/libs/ext-core/%s/ext-core.js'],
);
